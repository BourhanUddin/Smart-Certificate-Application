                ...
                <div class="container">
                    <div class="row d-flex justify-content-between">
                        <div class="topbar-left">
                            <ul>
                                <li><a href="{{ url('faq-1') }}"><i class="fa fa-question-circle"></i>Ask a
                                        Question</a></li>
                                <li><a href="{{ url('javascript:;') }}"><i
                                            class="fa fa-envelope-o"></i>support@puc.ac.bd</a></li>
                            </ul>
                        </div>
            ...
            <div class="sticky-header navbar-expand-lg">
                <div class="menu-bar clearfix">
                    <div class="container clearfix">
                        <!-- Header Logo ==== -->
                        <div class="menu-logo">
                            <a href="{{ url('index') }}" style="display: flex; flex-direction :row;">
                                <img src="{{ asset('/img/puc-rm.png') }}" alt="">
                                <p style="text-decoration: none; color:#fff; margin: 0px 10px;">
                                    Premier University
                                </p>
                            </a>
                        </div>
                        ...
                        <div class="secondary-menu">
                            <div class="secondary-inner">
                                <ul>
                                    <li><a href="{{ url('javascript:;') }}" class="btn-link"><i
                        ...
                        <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                            <div class="menu-logo">
                                <a href="{{ url('index') }}"><img src="{{ asset('/assets/images/logo.png') }}"
                                        alt=""></a>
                            </div>
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="{{ url('javascript:;') }}">Home <i
                                ...
                                <li><a href="{{ url('javascript:;') }}">Pages <i class="fa fa-chevron-down"></i></a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ url('javascript:;') }}">About<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('about-1') }}">About 1</a></li>
                                                <li><a href="{{ url('about-2') }}">About 2</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{ url('javascript:;') }}">Event<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-menu">
                                        ...
                                        <li><a href="{{ url('javascript:;') }}">FAQ's<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('faq-1') }}">FAQ's 1</a></li>
                                                <li><a href="{{ url('faq-2') }}">FAQ's 2</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{ url('javascript:;') }}">Contact Us<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('contact-1') }}">Contact Us 1</a></li>
                                                <li><a href="{{ url('contact-2') }}">Contact Us 2</a></li>
                                            </ul>
                                        </li>
                                ...
                                <li class="add-mega-menu"><a href="{{ url('javascript:;') }}">Our Courses <i
                                            class="fa fa-chevron-down"></i></a>
                                    <ul class="sub-menu add-menu">
                                        <li class="add-menu-left">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ url('courses-details') }}">Courses Details</a>
                                                </li>
                                                <li><a href="{{ url('profile') }}">Instructor Profile</a></li>
                                                <li><a href="{{ url('event') }}">Upcoming Event</a></li>
                                                <li><a href="{{ url('membership') }}">Membership</a></li>
                                            </ul>
                                        </li>
                                ...
                                <li><a href="{{ url('javascript:;') }}">Blog <i class="fa fa-chevron-down"></i></a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ url('blog-classic-grid') }}">Blog Classic</a></li>
                                        <li><a href="{{ url('blog-classic-sidebar') }}">Blog Classic Sidebar</a>
                                        </li>
                                        <li><a href="{{ url('blog-list-sidebar') }}">Blog List Sidebar</a></li>
                                        <li><a href="{{ url('blog-standard-sidebar') }}">Blog Standard
                                                Sidebar</a></li>
                                        <li><a href="{{ url('blog-details') }}">Blog Details</a></li>
                                    </ul>
                                </li>
                                <li class="nav-dashboard"><a href="{{ url('javascript:;') }}">Dashboard <i
                                            class="fa fa-chevron-down"></i></a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ url('admin/index') }}">Dashboard</a></li>
                                        <li><a href="{{ url('admin/add-listing') }}">Add Listing</a></li>
                                        <li><a href="{{ url('admin/bookmark') }}">Bookmark</a></li>
                                        <li><a href="{{ url('admin/courses') }}">Courses</a></li>
                                        <li><a href="{{ url('admin/review') }}">Review</a></li>
                                        <li><a href="{{ url('admin/teacher-profile') }}">Teacher Profile</a></li>
                                        <li><a href="{{ url('admin/user-profile') }}">User Profile</a></li>
                                        <li><a href="{{ url('javascript:;') }}">Calendar<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('admin/basic-calendar') }}">Basic
                                                        Calendar</a></li>
                                                <li><a href="{{ url('admin/list-view-calendar') }}">List View
                                                        Calendar</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{ url('javascript:;') }}">Mailbox<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('admin/mailbox') }}">Mailbox</a></li>
                                                <li><a href="{{ url('admin/mailbox-compose') }}">Compose</a></li>
                                                <li><a href="{{ url('admin/mailbox-read') }}">Mail Read</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <div class="nav-social-link">
                                <a href="{{ url('javascript:;') }}"><i class="fa fa-facebook"></i></a>
                                <a href="{{ url('javascript:;') }}"><i class="fa fa-google-plus"></i></a>
                                <a href="{{ url('javascript:;') }}"><i class="fa fa-linkedin"></i></a>
                            </div>
                        </div>
                        <!-- Navigation Menu END ==== -->
                    </div>
                    ...
                    <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;"
                        ...
                        <ul>
                            ...
                            <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default"
                                ...
                                data-easeout="default" data-masterspeed="default" data-thumb="error-404"
                                ...
                                <!-- MAIN IMAGE -->
                                <img src="{{ asset('/img/gec-campus.jpg') }}" alt=""
                            ...
                            <li data-index="rs-200" data-transition="parallaxvertical" data-slotamount="default"
                                ...
                                data-description="Science says that Women are generally happier">
                                <!-- MAIN IMAGE -->
                                <img src="{{ asset('/img/gec4.png') }}" alt=""
                                    data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                                    data-bgparallax="10" class="rev-slidebg" data-no-retina />
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    <div class="action-box">
                                        <img src="{{ asset('/assets/images/our-services/pic1.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        ...
                                        <h4><a href="{{ url('#') }}">Best Industry Leaders</a></h4>
                                        <a href="{{ url('#') }}" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    <div class="action-box">
                                        <img src="{{ asset('/assets/images/our-services/pic2.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                                        ...
                                        <h4><a href="{{ url('#') }}">Learn Courses Online</a></h4>
                                        <a href="{{ url('#') }}" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="service-bx m-b0">
                                    <div class="action-box">
                                        <img src="{{ asset('/assets/images/our-services/pic3.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                                        ...
                                        <h4><a href="{{ url('#') }}">Book Library & Store</a></h4>
                                        <a href="{{ url('#') }}" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                                <div class="item">
                                    <div class="cours-bx">
                                        ...
                                        <div class="info-bx text-center">
                                            <h5><a href="{{ url('#') }}">Introduction EduChamp – LMS plugin</a>
                                            </h5>
                ...
                <div class="section-area section-sp2">
                    <div class="container">
                                    ...
                                    <div class="event-bx">
                                        ...
                                        <div class="info-bx d-flex">
                                            ...
                                            <div class="event-info">
                                                <h4 class="event-title"><a href="{{ url('#') }}">Education
                                                        Autumn Tour 2019</a></h4>
                                                <ul class="media-post">
                                                    <li><a href="{{ url('#') }}"><i class="fa fa-clock-o"></i>
                                                            7:00am 8:00am</a></li>
                                                    <li><a href="{{ url('#') }}"><i
                                                                class="fa fa-map-marker"></i> Berlin, Germany</a></li>
                                                </ul>
                        ...
                        <div class="text-center">
                            <a href="{{ url('#') }}" class="btn">View All Event</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            <div class="item">
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="{{ asset('/assets/images/testimonials/pic1.jpg') }}"
                                            alt="">
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="{{ asset('/assets/images/testimonials/pic2.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="testimonial-info">
                                        <h5 class="name">Peter Packer</h5>
                        ...
                        <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            <div class="item">
                                <div class="recent-news">
                                    <div class="action-box">
                                        <img src="{{ asset('/assets/images/blog/latest-blog/pic1.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="info-bx">
                                        <ul class="media-post">
                                            <li><a href="{{ url('#') }}"><i class="fa fa-calendar"></i>Jan 02
                                                    2019</a></li>
                                            <li><a href="{{ url('#') }}"><i class="fa fa-user"></i>By
                                                    William</a></li>
                                        </ul>
                                        <h5 class="post-title"><a href="{{ url('blog-details') }}">This Story
                                                Behind Education Will Haunt You Forever.</a></h5>
                                        <p>Knowing that, you’ve optimised your pages countless amount of times, written
                                            tons.</p>
                                        <div class="post-extra">
                                            <a href="{{ url('#') }}" class="btn-link">READ MORE</a>
                                            <a href="{{ url('#') }}" class="comments-bx"><i
                            ...
                            <div class="item">
                                <div class="recent-news">
                                    <div class="action-box">
                                        <img src="{{ asset('/assets/images/blog/latest-blog/pic2.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="info-bx">
                                        <ul class="media-post">
                                            <li><a href="{{ url('#') }}"><i class="fa fa-calendar"></i>Feb 05
                                                    2019</a></li>
                                            <li><a href="{{ url('#') }}"><i class="fa fa-user"></i>By John</a>
                                            </li>
                                        </ul>
                                        <h5 class="post-title"><a href="{{ url('blog-details') }}">What Will
                                                Education Be Like In The Next 50 Years?</a></h5>
                                        <p>As desperate as you are right now, you have done everything you can on your.
                                        </p>
                                        <div class="post-extra">
                                            <a href="{{ url('#') }}" class="btn-link">READ MORE</a>
                                            <a href="{{ url('#') }}" class="comments-bx"><i
                                                    class="fa fa-comments-o"></i>14 Comment</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="recent-news">
                                    <div class="action-box">
                                        <img src="{{ asset('/assets/images/blog/latest-blog/pic3.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="info-bx">
                                        <ul class="media-post">
                                            <li><a href="{{ url('#') }}"><i class="fa fa-calendar"></i>April 14
                                                    2019</a></li>
                                            <li><a href="{{ url('#') }}"><i class="fa fa-user"></i>By
                                                    George</a></li>
                                        </ul>
                                        <h5 class="post-title"><a href="{{ url('blog-details') }}">Master The
                                                Skills Of Education And Be.</a></h5>
                                        <p>You will see in the guide all my years of valuable experience together with.
                                        </p>
                                        <div class="post-extra">
                                            <a href="{{ url('#') }}" class="btn-link">READ MORE</a>
                                            <a href="{{ url('#') }}" class="comments-bx"><i
                                                    class="fa fa-comments-o"></i>23 Comment</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex align-items-stretch">
                            ...
                            <div class="pt-social-link">
                                <ul class="list-inline m-a0">
                                    <li><a href="{{ url('#') }}" class="btn-link"><i
                                                class="fa fa-facebook"></i></a></li>
                                    <li><a href="{{ url('#') }}" class="btn-link"><i
                            ...
                            <div class="pt-btn-join">
                                <a href="{{ url('#') }}" class="btn ">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-4 col-lg-4 col-md-4 col-sm-4">
                                    <div class="widget footer_widget">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ url('about-1') }}">About</a></li>
                                            <li><a href="{{ url('faq-1') }}">FAQs</a></li>
                                            <li><a href="{{ url('contact-1') }}">Contact</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-4 col-lg-4 col-md-4 col-sm-4">
                                    <div class="widget footer_widget">
                                        ...
                                        <ul>
                                            <li><a
                                                    href="http://educhamp.themetrades.com/admin/index">Dashboard</a>
                                            </li>
                                            <li><a href="{{ url('blog-classic-grid') }}">Blog</a></li>
                                            <li><a href="{{ url('portfolio') }}">Portfolio</a></li>
                                            <li><a href="{{ url('event') }}">Event</a></li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-4 col-lg-4 col-md-4 col-sm-4">
                                    <div class="widget footer_widget">
                                        ...
                                        <ul>
                                            <li><a href="{{ url('courses') }}">Courses</a></li>
                                            <li><a href="{{ url('courses-details') }}">Details</a></li>
                                            <li><a href="{{ url('membership') }}">Membership</a></li>
                                            <li><a href="{{ url('profile') }}">Profile</a></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                            <div class="widget widget_gallery gallery-grid-4">
                                ...
                                <ul class="magnific-image">
                                    <li><a href="{{ url('assets/images/gallery/pic1.jpg') }}"
                                            class="magnific-anchor"><img
                                                src="{{ asset('/assets/images/gallery/pic1.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="{{ url('assets/images/gallery/pic2.jpg') }}"
                                            class="magnific-anchor"><img
                                                src="{{ asset('/assets/images/gallery/pic2.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="{{ url('assets/images/gallery/pic3.jpg') }}"
                                            class="magnific-anchor"><img
                                                src="{{ asset('/assets/images/gallery/pic3.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="{{ url('assets/images/gallery/pic4.jpg') }}"
                                            class="magnific-anchor"><img
                                                src="{{ asset('/assets/images/gallery/pic4.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="{{ url('assets/images/gallery/pic5.jpg') }}"
                                            class="magnific-anchor"><img
                                                src="{{ asset('/assets/images/gallery/pic5.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="{{ url('assets/images/gallery/pic6.jpg') }}"
                                            class="magnific-anchor"><img
                                                src="{{ asset('/assets/images/gallery/pic6.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="{{ url('assets/images/gallery/pic7.jpg') }}"
                                            class="magnific-anchor"><img
                                                src="{{ asset('/assets/images/gallery/pic7.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="{{ url('assets/images/gallery/pic8.jpg') }}"
                                            class="magnific-anchor"><img
