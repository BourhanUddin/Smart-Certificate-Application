...
<body>
    <div>
        <div id="section-to-print" class="container pm-certificate-container">
            <div class="outer-border"></div>
            <div class="inner-border"></div>

            <div class="pm-certificate-border col-12">
                <img src="https://chart.googleapis.com/chart?cht=qr&chl={{ gethostbyname(gethostname()) }}/student/alumni-info/{{ auth()->user()->student->id }}&chs=160x160&chld=L|0"
                            ...
                            <div class="row">
                                ...
                                <div class="pm-earned col-8 text-center">
                                    <span class="pm-earned-text padding-0 block cursive">
                                        ...
                                        <b> {{ auth()->user()->name }} </b>
                                        has ended BSc. in CSE with cgpa of {{ auth()->user()->student->cgpa }}
                                    </span>
    ...
    <button id="downloadButton" class="btn btn-success" style="margin-left: 20px;"
        onclick="printDiv('cert_with_border')">Download</button>
